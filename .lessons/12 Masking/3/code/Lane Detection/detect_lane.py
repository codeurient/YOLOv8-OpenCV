...
while True:
    ...
    # 1) getTrackbarPos() - Bu metod trackbar-ın mövcud dəyərini alır. Trackbar istifadəçinin dəyişikliklər edə biləcəyi bir sürüşmə çubuğudur:
    #                       "L-H": Bu, hansı trackbar-ın dəyərini oxumaq istədiyimizi bildirir.
    #                       "Tracksbars": Trackbar-ın yerləşdiyi pəncərənin adı.
    ...
    # 2) Rəngləri Array içinə yerləşdiririk
    LOWER = np.array([LOWER_H, LOWER_S, LOWER_V])
    UPPER = np.array([UPPER_H, UPPER_S, UPPER_V])

    # 3) HSV formatına çevirdiyimiz frame-ə, inRange() metodu ilə, müəyyən bir rəng aralığında olan pikselləri tətbiq edirik. (AĞ və QARA) - Şəkil 1 
...
# 4) Bundan sonrakı addımda yol işarətlərinin yerini aşkar etmək, təyin etmək lazımdır. Bunun üçündə HISTOGRAM istifadə etməliyik. 
# Histogram, bir şəkilin və ya verilən məlumat dəstəsinin fərqli dəyər aralıqlarında (interval) neçə dəfə təkrarlandığını göstərən bir qrafik təsviridir.
# Loru dildə desək işarətlərin üzərinə, qrafik bir təsvir (qutu) qoyacağıq. 
